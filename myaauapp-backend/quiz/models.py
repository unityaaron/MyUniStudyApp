...
class Course(models.Model):
    code = models.CharField(max_length=50)  # e.g., GST101, GST102
    title = models.CharField(max_length=200)  # e.g., Use of English
...
class Question(models.Model):
    ...
    correct_answer = models.TextField()  # A, B, C or D
...
class JobPost(models.Model):
    ...
    date_posted = models.CharField(max_length=500, blank=True, null=True)
