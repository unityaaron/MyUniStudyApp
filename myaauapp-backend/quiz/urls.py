...
from .views import CourseQuestionsView, JobPostListView, SubmitQuizResultView, LeaderboardView, ScholarshipPostListAPIView
...
urlpatterns= [
    ...
    path('scholarships/', ScholarshipPostListAPIView.as_view(), name='scholarship-list'),
