...
    axios.get(import.meta.env.VITE_API_URL + '/api/quiz/questions/CHM101/')
      .then((response) => {
...
        marginBottom: '20px'
      }}>
        <h1><span style={{color: 'black'}}>CHM101 Quiz</span></h1>
        <div>
          <span style={{
