...
    axios.get(import.meta.env.VITE_API_URL + '/api/quiz/questions/BIO101/')
      .then((response) => {
...
        marginBottom: '20px'
      }}>
        <h1><span style={{color: 'black'}}>BIO101 Quiz</span></h1>
        <div>
          <span style={{
